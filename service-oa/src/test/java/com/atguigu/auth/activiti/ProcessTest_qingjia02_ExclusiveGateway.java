...
@SpringBootTest
public class ProcessTest_qingjia02_ExclusiveGateway {
    //RepositoryService:
    ...
    public void deployProcess(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                ...
                .addClasspathResource("process/qingjia02Gateway_exclusive.bpmn20.xml")
                .addClasspathResource("process/qingjia02Gateway_exclusive.png")
                .name("请假申请流程-排他网关")
                .deploy();
    ...
    public void startProcess(){
        ...
        //设置请假天数
        map.put("day","2");
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("qingjia02Gateway_exclusive",map);
    ...
    public void findProcessDefinitionList(){
        List<ProcessDefinition> definitionList = repositoryService.createProcessDefinitionQuery()
                .processDefinitionKey("qingjia02Gateway_exclusive")
    ...
    public void deleteDeployment() {
        //部署id
        String deploymentId = "988e6371-0100-11ee-8e19-f430b99350b4";
